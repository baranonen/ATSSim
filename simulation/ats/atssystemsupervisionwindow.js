...
class ATSSystemSupervisionWindow {
    ...
    dateText
    constructor() {
        fetch("./ats/resources/systemsupervisionactivity.svg")
                ...
                .then(function(svgText) {
                    ...
                    // Append the SVG to the container in the DOM
                    this.HTMLElement = svgElement
                }.bind(this))
                .catch(function(error) {
                    console.error("Error fetching or inlining SVG:", error);
                });
    }
    ...
    startTime() {
        ...
        var dateText = d + "/" + mo + "/" + y
        var timeText = h + ":" + m + ":" + s
        this.dateText.getElementsByTagName("tspan")[0].innerHTML = dateText
        this.timeText.getElementsByTagName("tspan")[0].innerHTML = timeText
        var t = setTimeout(this.startTime.bind(this), 1000)
    }
